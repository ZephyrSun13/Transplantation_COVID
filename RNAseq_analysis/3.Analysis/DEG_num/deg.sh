...
Rscript /sc/arion/projects/zhangw09a/PANDA/ext_ZS/bin/code/limmaVoomNum.r ../Expr.match.xls Factor.xls unpaired Group Score 0 0.01 Ensembl Group "Age;Sex;Batch;Lymph" voom 1
...
head -1 Group_Group_Score_Age_Sex_Batch_Lymph_Group_diff.ann.xls > GeneCheck.xls

awk -F "\t" '($8=="TNF")' Group_Group_Score_Age_Sex_Batch_Lymph_Group_diff.ann.xls >> GeneCheck.xls
